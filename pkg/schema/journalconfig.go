...
type JournalConfig struct {
	...
	ExpenseAdvancedByEmployeeDescription string `yaml:"expenseAdvancedByEmployeeDescription" default:"Bezahlung der Rechnung {{ .Ident }} durch {{ .Party }} mit Privatvermögen"`
